    ...
    <nav class="navbar navbar-expand-sm bg-light navbar-light">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item me-3">
                    <a href="/project_H/diary/diarylist" class="nav-link btn btn-outline-secondary"
                ...
                <c:if test="${not empty sessCustId}">
                    <li class="nav-item me-3">
                        <div class="dropdown">
                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="profileMenu"
