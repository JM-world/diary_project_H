...
<body>
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/board/write" method="post" modelAttribute="board">
            ...
            <form:textarea path="title" id="title" name="title" required="true"></form:textarea>

            <label for="content">내용:</label>
            <form:textarea path="content" id="content" name="content" rows="4" required="true"></form:textarea>

            <!-- bid와 custId는 hidden 필드로 전송 -->
            <form:hidden path="bid" />
            <c:if test="${not empty sessionScope.custId}">
                <form:hidden path="custId" value="${sessionScope.custId}" />
            </c:if>
